...
def map():
    ...
    if perception_check >= map_perception:
        ...
        if gold_persuasion == gold_for_map:
            gold = input("How much do you offer?: ")
            if gold >= "500":
                ...
                print("\nShe shuffles the cards and begins setting them on a small table in the middle of the carriage")
        elif gold_persuasion == persuasion_for_map:
            persuasion = input("Persuasion Check (Charisma + roll): ")
            if persuasion >= "11":
...
def reading():
    ...
    print("1. The Tome of Strahd",
          "This card tells of history. Knowledge of the ancient will help you better understand your enemy.")
    print("2. The Holy Symbol of Ravenkind",
          "This card tells of a powerful force for good and protection, a holy symbol of great hope.")
    print("3. The Sunsword",
          "This is a card of power and strength. It tells of a weapon of vengeance: a sword of sunlight.")
    print("4. Strahd’s enemy", 'This card sheds light on one who will help '
                               'you greatly in the battle against darkness.')
    print("5. Strahd’s location",
    ...
    map_in_inventory = input("\nDoes your party have the map?")
    if map_in_inventory == "no":
        slight_of_hand = input("\nSlight of hand Check (Dex + roll): ")
        if slight_of_hand == map_snatch:
            print("Success: “You fall forward and land on to Madam Eva and take the map.")
        else:
...
def arrive():
    print(
        'The carriage careens into courtyard of Castle Ravenloft and crashes as the horses fall mysteriously dead. '
        'You are hurled from the carriage into the courtyard. As you rise, muddy and soaked through, a massive and ghostly apparition of Strahd appears before them. '
        'He cackles at their misfortune and raises an hourglass filled with blood-red sand. He looks down upon them and says:'
        ...
        'I grant you four cosmic hours to explore the castle, uncover its mysteries, and confront me."' 
        'Strahd turns over the hourglass and the sands begin to trickle into the bottom bell."'
        '"But when the sands of time run out, so too will your lives." "Welcome to Castle Ravenloft."" ""Welcome "."".""." "to your doom!”'
)
